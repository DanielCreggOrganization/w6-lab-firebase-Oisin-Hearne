...
import {
  ...
  createUserWithEmailAndPassword, sendPasswordResetEmail, // Used to create a user in Firebase auth.
...
export class AuthService {
  ...
  async passReset(email: string) {
    try{
      ...
      console.log("Error with pass reset, ",e);
    }
